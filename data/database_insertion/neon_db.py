...
class NeonDatabaseConnection:
    ...
    def insert_mob(self,
                   ...
                   creation_date: Optional[str] = None) -> bool:
        """
        ...
        try:
            ...
            (mob_name, mob_description, prompt, mob_keywords, mob_geometry, mob_embedding, bone_metadata, complexity_score, is_official, creation_date)
    ...
    def get_mob(self, mob_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            cursor.execute("SELECT * FROM mob_geometries WHERE mob_name = %s", (mob_name,))
            row = cursor.fetchone()
            cursor.close()
