...
var SkinManifestDefinition_exports = {};
__export(SkinManifestDefinition_exports, {
  default: () => SkinManifestDefinition
});
module.exports = __toCommonJS(SkinManifestDefinition_exports);
...
class SkinManifestDefinition {
  ...
  static async ensureOnFile(file, loadHandler) {
    ...
    if (file.manager !== void 0 && file.manager instanceof SkinManifestDefinition) {
      rmj = file.manager;
      if (!rmj.isLoaded) {
        if (loadHandler) {
...
//# sourceMappingURL=SkinManifestDefinition.js.map
