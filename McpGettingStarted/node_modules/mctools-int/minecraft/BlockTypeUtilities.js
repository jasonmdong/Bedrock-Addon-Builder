...
var BlockTypeUtilities_exports = {};
__export(BlockTypeUtilities_exports, {
  default: () => BlockTypeUtilities
});
module.exports = __toCommonJS(BlockTypeUtilities_exports);
class BlockTypeUtilities {
  // Keyword hints map - Minecraft-inspired color associations
  // Check in order of specificity (more specific keywords first)
  static keywordColorHints = [
    // Metals and ores
    [["gold", "gilded"], "#f9d849"],
   ...
   */
  static getCustomBlockFallbackColor(blockTypeId) {
    ...
    const saturation = 40 + Math.abs(hash >> 8) % 31;
    const lightness = 35 + Math.abs(hash >> 16) % 26;
    return BlockTypeUtilities.hslToHex(hue, saturation, lightness);
  }
}
//# sourceMappingURL=BlockTypeUtilities.js.map
