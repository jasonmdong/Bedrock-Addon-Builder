...
var ContentWizardTemplates_exports = {};
__export(ContentWizardTemplates_exports, {
  BlockTemplates: () => BlockTemplates,
  EntityTemplates: () => EntityTemplates,
  ItemTemplates: () => ItemTemplates,
  TexturePatterns: () => TexturePatterns,
  customizeBlockTemplate: () => customizeBlockTemplate,
  customizeEntityTemplate: () => customizeEntityTemplate,
  customizeItemTemplate: () => customizeItemTemplate,
  getBlockTemplate: () => getBlockTemplate,
  getBlockTemplateNames: () => getBlockTemplateNames,
  getEntityTemplate: () => getEntityTemplate,
  getEntityTemplateNames: () => getEntityTemplateNames,
  getItemTemplate: () => getItemTemplate,
  getItemTemplateNames: () => getItemTemplateNames,
  getTexturePattern: () => getTexturePattern,
  getTexturePatternNames: () => getTexturePatternNames
});
module.exports = __toCommonJS(ContentWizardTemplates_exports);
...
const EntityTemplates = {
  ...
  humanoid_hostile: {
    ...
    attackDamage: 3,
    movementSpeed: 0.23,
    drops: [{ item: "minecraft:rotten_flesh", count: { min: 0, max: 2 }, chance: 1 }],
    spawning: {
...
function customizeBlockTemplate(templateName, overrides) {
...
function customizeItemTemplate(templateName, overrides) {
...
0 && (module.exports = {
  ...
  ItemTemplates,
  TexturePatterns,
  customizeBlockTemplate,
  customizeEntityTemplate,
  customizeItemTemplate,
  getBlockTemplate,
  getBlockTemplateNames,
  getEntityTemplate,
  getEntityTemplateNames,
  getItemTemplate,
  getItemTemplateNames,
  getTexturePattern,
  getTexturePatternNames
});
//# sourceMappingURL=ContentWizardTemplates.js.map
