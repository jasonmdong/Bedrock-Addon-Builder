...
var ChestBlockActor_exports = {};
__export(ChestBlockActor_exports, {
  default: () => ChestBlockActor
});
module.exports = __toCommonJS(ChestBlockActor_exports);
var import_BlockActor = __toESM(require("./BlockActor"));
class ChestBlockActor extends import_BlockActor.default {
  findable;
  items = [];
  load() {
    if (!this.rootTag) {
...
//# sourceMappingURL=ChestBlockActor.js.map
