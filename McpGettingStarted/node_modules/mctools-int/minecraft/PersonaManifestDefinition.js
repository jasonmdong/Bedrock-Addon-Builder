...
var PersonaManifestDefinition_exports = {};
__export(PersonaManifestDefinition_exports, {
  default: () => PersonaManifestDefinition
});
module.exports = __toCommonJS(PersonaManifestDefinition_exports);
...
class PersonaManifestDefinition {
  _file;
  _id;
  _isLoaded = false;
  ...
  static async ensureOnFile(file, loadHandler) {
    ...
    if (file.manager !== void 0 && file.manager instanceof PersonaManifestDefinition) {
      rmj = file.manager;
      if (!rmj.isLoaded) {
        if (loadHandler) {
  ...
  persist() {
    ...
    if (!this.definition) {
      import_Log.default.unexpectedUndefined("PMRDP");
      return false;
    }
...
//# sourceMappingURL=PersonaManifestDefinition.js.map
